...
export class BalanceSheetComponent {
    ...
    subsidiaries.forEach(subsidiary => {
      subsidiary.areas.forEach((area:any) => {
        ...
        excelData.push({
          Codigo: 'Total Activo',
          Cuenta: '',
          Monto: area.totalActive
        });
        excelData.push({
          Codigo: 'Total Pasivo + Capital',
          Cuenta: '',
          Monto: area.totalPasiveCapital
        });
        excelData.push({
          Codigo: 'Total Resultado',
          Cuenta: '',
          Monto: area.totalResult
        });
        excelData.push({
          Codigo: 'Total Activo Final',
          Cuenta: '',
          Monto: area.totalActiveFinal
        });
        excelData.push({
          Codigo: 'Total Resultado Final',
          Cuenta: '',
          Monto: area.totalResultFinal
        });
  ...
  proceedToGenerateExcel(data: any[], headersInfo:any) {
    ...
    anchor.setAttribute('download', 'balance_general.csv');
